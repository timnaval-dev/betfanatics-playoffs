...
const PLAYOFFS_DATA = {
  ...
  series: {
    ...
    "e1-atl-1v4": {
      ...
      conference: "East",
      round: 1,
      topSeed: { name: "Toronto Maple Leafs", short: "TOR" },
    ...
    "e1-atl-2v3": {
      ...
      botSeed: { name: "Florida Panthers",  short: "FLA" },
      mode: "auto",
    ...
    "e1-met-1v4": {
      ...
      conference: "East",
      round: 1,
      topSeed: { name: "Washington Capitals",  short: "WSH" },
    ...
    "e1-met-2v3": {
      ...
      botSeed: { name: "New Jersey Devils",     short: "NJD" },
      mode: "auto",
    ...
    "w1-cen-1v4": {
      ...
      conference: "West",
      round: 1,
      topSeed: { name: "Winnipeg Jets",  short: "WPG" },
      botSeed: { name: "St. Louis Blues", short: "STL" },
      mode: "auto",
      auto: { topHomeWinPct: 0.62, botHomeWinPct: 0.45 },
      manual: { game1: 0.62, game2: 0.62, game3: 0.55, game4: 0.55, game5: 0.62, game6: 0.55, game7: 0.62 },
      state: { topWins: 0, botWins: 0, history: [[0,0]] },
    ...
    "w1-cen-2v3": {
      ...
      botSeed: { name: "Colorado Avalanche", short: "COL" },
      mode: "auto",
      auto: { topHomeWinPct: 0.50, botHomeWinPct: 0.55 },
      manual: { game1: 0.50, game2: 0.50, game3: 0.45, game4: 0.45, game5: 0.50, game6: 0.45, game7: 0.50 },
      state: { topWins: 0, botWins: 0, history: [[0,0]] },
    ...
    "w1-pac-2v3": {
      ...
      conference: "West",
      round: 1,
      topSeed: { name: "Los Angeles Kings",  short: "LAK" },
      botSeed: { name: "Edmonton Oilers", short: "EDM" },
      mode: "auto",
